...
Post-level responses are stored under `responses/post-validation-component-first-v1/`. This keeps them separate from the main direct-PRUS exercise, the cue-and-scope hybrid exercise, and the superseded sentence-level exercise.
